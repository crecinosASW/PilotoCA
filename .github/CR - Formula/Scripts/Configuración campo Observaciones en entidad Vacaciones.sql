...
IF NOT EXISTS (SELECT NULL FROM cfg.pbf_property_bag_fields WHERE pbf_entidad = 'SolicitudesVacaciones' AND pbf_field_name = 'Observaciones')
	...
	VALUES ('SolicitudesVacaciones', 'Observaciones', 'Observaciones', NULL, 'string', NULL, 'DropDownList', NULL, NULL, 0, '2015-03-18 15:45:54', 'admin', NULL, NULL)
