...
FROM (
	...
	SELECT 2 orden,
		NULL exp_codigo_alternativo,
		REPLICATE('0', 3) +
		RIGHT(REPLICATE('0', 1) + ISNULL(SUBSTRING(REPLACE(@cia_cuenta, '-', ''), 1, 1), ''), 1) +
		REPLICATE('0', 5) +	
		RIGHT(REPLICATE('0', 3) + ISNULL(SUBSTRING(REPLACE(@cia_cuenta, '-', ''), 2, 3), ''), 3) +
		RIGHT(REPLICATE('0', 7) + ISNULL(SUBSTRING(REPLACE(@cia_cuenta, '-', ''), 5, 7), ''), 7) +
		RIGHT(REPLICATE('0', 1) + ISNULL(SUBSTRING(REPLACE(@cia_cuenta, '-', ''), 12, 1), ''), 1) +
	...
	SELECT 3 orden,
		...
		REPLICATE('0', 3) +
		RIGHT(REPLICATE('0', 1) + ISNULL(SUBSTRING(REPLACE(cbe_numero_cuenta, '-', ''), 1, 1), ''), 1) +
		REPLICATE('0', 5) +	
		RIGHT(REPLICATE('0', 3) + ISNULL(SUBSTRING(REPLACE(cbe_numero_cuenta, '-', ''), 2, 3), ''), 3) +
		RIGHT(REPLICATE('0', 7) + ISNULL(SUBSTRING(REPLACE(cbe_numero_cuenta, '-', ''), 5, 7), ''), 7) +
		RIGHT(REPLICATE('0', 1) + ISNULL(SUBSTRING(REPLACE(cbe_numero_cuenta, '-', ''), 12, 1), ''), 1) +
		RIGHT(REPLICATE('0', 1) + ISNULL(
			(CASE
