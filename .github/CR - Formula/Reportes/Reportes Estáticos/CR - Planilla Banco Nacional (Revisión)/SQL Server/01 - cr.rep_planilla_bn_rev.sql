IF EXISTS (SELECT 1
		   FROM sys.objects 
		   WHERE object_id = object_id('cr.rep_planilla_bn_rev'))
BEGIN
	DROP PROCEDURE cr.rep_planilla_bn_rev
END

GO

--EXEC cr.rep_planilla_bn_rev 1, '1', '201438', 'admin'
CREATE PROCEDURE cr.rep_planilla_bn_rev (
	@codcia INT = NULL,
