IF EXISTS (SELECT NULL
		   FROM sys.objects
		   WHERE object_id = object_id('cr.rep_accion_retiro'))
BEGIN
	DROP PROCEDURE cr.rep_accion_retiro
END

GO

--EXEC cr.rep_accion_retiro 1, '2482', '11/02/2015', NULL, 'admin'
CREATE PROCEDURE cr.rep_accion_retiro (
	@codcia INT = NULL,
...
SELECT cia_descripcion acc_compania,
	ret_codigo acc_numero,
	'RET' acc_abreviatura,
	'RETIRO' acc_tipo,
	ret_fecha_retiro acc_fecha_accion,
	...
	NULL acc_ausencia,
	ret_fecha_retiro acc_fecha_rige,
	NULL acc_fecha_hasta,
	NULL acc_dias,
	'RET' acc_estado,
	NULL acc_salario,
	NULL acc_moneda,
	ISNULL(@comentario, ret_observacion) acc_comentario,
	@usuario acc_usuario
FROM acc.ret_retiros
	JOIN exp.emp_empleos ON	ret_codemp = emp_codigo
