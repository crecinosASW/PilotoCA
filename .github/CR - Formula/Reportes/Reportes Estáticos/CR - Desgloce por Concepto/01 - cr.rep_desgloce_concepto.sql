...
CREATE PROCEDURE cr.rep_desgloce_concepto (
	...
	@codtdc_primero INT = NULL,
	@codtdc_segundo INT = NULL,
	@codtdc_tercero INT = NULL,
	@codtdc_cuarto INT = NULL,
	@codtdc_quinto INT = NULL,
...
WHERE ppl_codtpl = @codtpl
	...
	AND dss_codtdc IN (ISNULL(@codtdc_primero, dss_codtdc), @codtdc_segundo, @codtdc_tercero, @codtdc_cuarto, @codtdc_quinto)
