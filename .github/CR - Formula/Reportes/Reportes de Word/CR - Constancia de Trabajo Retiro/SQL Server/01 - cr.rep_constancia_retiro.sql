IF EXISTS (SELECT NULL 
		   FROM sys.objects
		   WHERE object_id = object_id('cr.rep_constancia_retiro'))
BEGIN
	DROP PROCEDURE cr.rep_constancia_retiro
END

GO	

--EXEC cr.rep_constancia_retiro 2, '108', '56', 'Guatemala', '10/08/2014', 'jcsoria'
CREATE PROCEDURE cr.rep_constancia_retiro (
	@codcia INT = NULL,
...
SELECT ISNULL(@ciudad, pai_descripcion) cts_pais,
	...
	gen.convierte_fecha_a_letras(emp_fecha_retiro, 0, 1) cts_fecha_retiro,
