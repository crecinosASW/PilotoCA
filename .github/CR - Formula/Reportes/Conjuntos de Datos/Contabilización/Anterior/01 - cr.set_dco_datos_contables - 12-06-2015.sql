...
--SELECT * FROM cr.set_dco_datos_contables
...
SELECT emp_codigo,
	...
	dco_cta_contable,
	dco_descripcion,
	ROUND(dco_debitos, 2) dco_debitos,
	ROUND(dco_creditos, 2) dco_creditos,
	ROUND(dco_creditos - dco_debitos, 2) dco_valor,
	dco_tasa_cambio,	
	ROUND(dco_debitos_usd, 2) dco_debitos_usd,
	ROUND(dco_creditos_usd, 2) dco_creditos_usd,
	ROUND(dco_creditos_usd - dco_debitos_usd, 2) dco_valor_usd
