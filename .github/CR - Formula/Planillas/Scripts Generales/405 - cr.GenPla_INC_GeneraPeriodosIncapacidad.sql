...
--EXEC cr.GenPla_INC_GeneraPeriodosIncapacidad null, 1134, 'admin'
...
BEGIN
	...
	--PRINT 'Fondo Incapacidad: ' + ISNULL(CONVERT(VARCHAR, @codfin), '')
	...
	BEGIN
		...
		--PRINT 'Días Incapacidad: ' + ISNULL(CONVERT(VARCHAR, @dias_incap), '')
