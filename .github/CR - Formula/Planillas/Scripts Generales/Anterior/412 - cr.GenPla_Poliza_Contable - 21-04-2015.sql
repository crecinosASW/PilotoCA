...
BEGIN
    ...
    GROUP BY inn_codppl, tig_cuenta, cco_nomenclatura_contable, tig_descripcion, cco_descripcion
    ...
    GROUP BY  dss_codppl, tdc_cuenta, tdc_codigo, tdc_descripcion
    ...
    GROUP BY res_codppl, trs_cuenta, trs_codigo, cco_codigo,  trs_descripcion, cco_descripcion, cco_nomenclatura_contable
    ...
    FROM sal.res_reservas
        join sal.trs_tipos_reserva on trs_codigo = res_codtrs
    WHERE res_codppl = @codppl
    GROUP BY res_codppl, trs_cuenta_aux, trs_codigo, trs_descripcion
