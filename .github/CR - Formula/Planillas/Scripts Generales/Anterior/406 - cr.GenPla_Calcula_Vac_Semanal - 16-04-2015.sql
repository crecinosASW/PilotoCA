...
SET @salario_minimo_diario = ISNULL(gen.get_valor_parametro_float('SalarioMinimoDiario', @codpai, NULL, NULL, NULL), 0.00)
...
FETCH NEXT FROM vacaciones INTO @codemp, @coddva, @dva_desde, @dva_hasta, @emp_salario, @dias_vacaciones
...
BEGIN
	...
	ELSE
	BEGIN
		SET @valor_base = @salario_minimo_diario * @divisor
