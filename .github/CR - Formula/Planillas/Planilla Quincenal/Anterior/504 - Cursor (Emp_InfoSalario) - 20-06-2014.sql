...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_InfoSalario';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_InfoSalario','Emp_InfoSalario','SELECT 0 EMP_CODIGO,
     '''' EMP_ESTADO,
