...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Amonestacion';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Amonestacion','Emp_Amonestacion','Select 0 AMO_CODCIA,
        AMO_CODIGO, 
		AMO_CODEMP, 
		AMO_CODTAM, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Dias_Vacaciones';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Dias_Vacaciones','Emp_Dias_Vacaciones','select 0 dva_codcia, 
        0 ppl_codtpl, 
        0 ppl_codpla, 
        0 dva_codemp,
		dva_desde, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Dias_VacacionesPago';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Dias_VacacionesPago','Pago por Vacaciones gozadas','select 0    vca_codtpl,
       0    vca_codppl, 
       0    vca_codemp, 
       0    vca_dias_gozados,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_DiasIncapacidad';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_DiasIncapacidad','Emp_DiasIncapacidad','select 0 ixe_codcia, 
		ixe_codemp,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_DiasIncapacidadPago';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_DiasIncapacidadPago','Pago por Incapacidades del seguro social','SELECT 0 IXE_CODEMP, 
       0 PPL_CODTPL,
       0 PPL_CODIGO, 
       0 IXE_CODIGO, 
       0.00 IXE_DIAS_INCAPACITADO, 
       0.00 PIE_VALOR_TOTAL,
       0.00 PIE_VALOR_PAGA_IGSS, 
       0.00 PIE_PAGO_EN_NOMINA,
       0.00 PIE_DIAS
','SELECT IXE_CODEMP, 
       PPL_CODTPL,
       PPL_CODIGO, 
       ...
       PIE_VALOR_TOTAL,
       PIE_VALOR_A_PAGAR PIE_VALOR_PAGA_IGSS, 
       PIE_VALOR_A_PAGAR PIE_PAGO_EN_NOMINA,
       PIE_DIAS
  FROM acc.ixe_incapacidades
 JOIN acc.pie_periodos_incapacidad ON pie_codixe = ixe_codigo
 JOIN sal.ppl_periodos_planilla ON ppl_codigo = pie_codppl
 	where PPL_CODIGO = $$CODPPL$$
	and sal.empleado_en_gen_planilla(''$$SESSIONID$$'', ixe_codemp) = 1','ixe_codemp','ppl_codigo','ppl_codtpl','TodosExcluyendo',0,0);
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_HorasExtras';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_HorasExtras','Emp_HorasExtras','Select  0 EXT_CODCIA,
    EXT_CODEMP,
    EXT_CODTHE,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Incremento_BoniLey_Retro';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Incremento_BoniLey_Retro','Emp_Incremento_BoniLey_Retro','SELECT PIR_CODIGO,
	PIR_CODPPL, 
	PIR_CODEMP, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_IncrementoBoniPactadaRetro';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_IncrementoBoniPactadaRetro','Emp_IncrementoBoniPactadaRetro','SELECT PIR_CODIGO,
	PIR_CODPPL, 
	PIR_CODEMP, 
	PIR_MONTO_RETROACTIVO, 
	PIR_DIAS_RETROACTIVO, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_IncrementoSalarioRetro';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_IncrementoSalarioRetro','Emp_IncrementoSalarioRetro','SELECT PIR_CODIGO,
	PIR_CODPPL, 
	PIR_CODEMP, 
	PIR_MONTO_RETROACTIVO, 
	PIR_DIAS_RETROACTIVO, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_ISR_Calculado';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_ISR_Calculado','Emp_ISR_Calculado','SELECT ICI_CODEMP,
	   ICI_RENTA_BRUTA,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Nuevo_Ingreso';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Nuevo_Ingreso','Empleados de Nuevo Ingreso que iniciaron luego de pagada la planilla','SELECT *
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_OtrosDescuentos';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_OtrosDescuentos','Emp_OtrosDescuentos','select * 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_OtrosIngresos';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_OtrosIngresos','Emp_OtrosIngresos','select *
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Promedio_Aguinaldo';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Promedio_Aguinaldo','Obtiene los datos calculados de Aguinaldo','SELECT CAG_CODPPL,
	CAG_CODEMP,
	CAG_MONTO_PAGAR,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Promedio_Bono14';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Promedio_Bono14','Trae los datos calculados en la Inicializacion, sobre bono 14','SELECT B14_CODPPL,
	B14_CODEMP,
	B14_MONTO_PAGAR,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Emp_Sustitucion';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Emp_Sustitucion','Para calculo del pago de sustituciones temporales','Select
0 ste_codppl,
0 ste_codemp,
0.00 ste_valor,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'GeneralesPorEmpresa';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codcia,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','GeneralesPorEmpresa','GeneralesPorEmpresa','select 0 pge_mes_descontar_boleto,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Isr_Isr';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Isr_Isr','Tabla de ISR Guatemala','select inicio isr_desde, fin isr_hasta, porcentaje isr_pct, excedente isr_excedente, valor isr_valor
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'ParametrosCuotaIGSS';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','ParametrosCuotaIGSS','ParametrosCuotaIGSS','SELECT 0 EMP_CODCIA,
	0 EMP_CODIGO,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Pla_Periodo';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Pla_Periodo','Pla_Periodo','select sal.ppl_periodos_planilla.*, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'Pla_Periodo_Anterior';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codppl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','Pla_Periodo_Anterior','Pla_Periodo_Anterior','select PPL_CODTPL, 
	PPL_CODIGO, 
	PPL_FECHA_INI,              
	PPL_FECHA_FIN, 
	PPL_FECHA_PAGO, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'prestaciones_empleado';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','prestaciones_empleado','prestaciones_empleado','select 0 ppe_codemp,
       0 ppe_codpres,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'prestaciones_puesto';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_field_codcia,fcu_field_codppl,fcu_field_codtpl,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','prestaciones_puesto','prestaciones_puesto','select GETDATE() PPP_FECHA_INI, 
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'RubroBoniPactada';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','RubroBoniPactada','Recoge los datos del Salario Ordinario del Empleado','select 0 esa_codemp, 
       0 esa_es_salario_base,
       0.00 esa_valor,
       0 esa_codmon,
       0.00 esa_valor_hora,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'RubroSalario';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','RubroSalario','Recoge los datos del Salario Ordinario del Empleado','select 0 esa_codemp, 
       0 esa_es_salario_base,
       0.00 esa_valor,
       0 esa_codmon,
       0.00 esa_valor_hora,
...
delete from sal.fcu_formulacion_cursores where fcu_codpai = 'gt' and fcu_nombre = 'SeguroPorEmpleado';


insert into sal.fcu_formulacion_cursores (fcu_codpai,fcu_proceso,fcu_nombre,fcu_descripcion,fcu_select_edit,fcu_select_run,fcu_field_codemp,fcu_modo_asociacion_tpl,fcu_loop_calculo,fcu_updatable) values ('gt','Planilla','SeguroPorEmpleado','SeguroPorEmpleado','select 0 sem_codemp,
		0 sem_codsme,
		0 sme_codtsm,
		0.00 sem_cuota_emp,
