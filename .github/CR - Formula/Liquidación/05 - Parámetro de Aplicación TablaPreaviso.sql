...
DELETE FROM gen.par_parametros WHERE par_codigo ='TablaPreaviso'
...
VALUES ('TablaPreaviso', 'Tabla utilizada para el pago del preaviso', 'Double', 'Dias', 'R', NULL, 'admin', GETDATE(), NULL, NULL)
...
VALUES (NULL, NULL, 'TablaPreaviso', 'cr', NULL, NULL, NULL, NULL, 'admin', GETDATE(), NULL, NULL)
...
INSERT gen.rap_rangos_alcance_parametros (rap_codapa, rap_inicio, rap_fin, rap_porcentaje, rap_excedente, rap_valor, rap_usuario_grabacion, rap_fecha_grabacion, rap_usuario_modificacion, rap_fecha_modificacion) 
VALUES (@codapa, 7.0000, 13.0000, 0.0000, 0.0000, 15.0000, 'admin', GETDATE(), NULL, NULL)
INSERT gen.rap_rangos_alcance_parametros (rap_codapa, rap_inicio, rap_fin, rap_porcentaje, rap_excedente, rap_valor, rap_usuario_grabacion, rap_fecha_grabacion, rap_usuario_modificacion, rap_fecha_modificacion) 
VALUES (@codapa, 13.0000, 1000000000.0000, 0.0000, 0.0000, 30.0000, 'admin', GETDATE(), NULL, NULL)
